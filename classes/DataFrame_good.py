...
class DataFrame():
     ...
     def get_df_column_order(self, col_idx):
        ...
        leg_order = ['carrier', 'number', 'aircraft', 'origin', 'destination',
                     'cabin', 'duration', 'mileage', 'meal', 'departureTime',
                     'arrivalTime', 'connectionDuration', 'originTerminal',
     ...
     def add_trip_to_dataframe(self, trips):
        ...
        for trip in trips:
            ...
            self.df.loc[len(self.df)] = reform
